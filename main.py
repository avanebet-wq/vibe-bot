...
# --- ШУТОЧНАЯ КОМАНДА «КУРНУТЬ ТРАВКУ» ---
...
def text_handler(m):
    try:
        ...
        if cmd in ["повысить", "понизить", "разжаловать", "пред", "/warn", "/unwarn", "мут", "/mute", "снять", "/unmute", "бан", "/ban", "снятьбан", "/unban", "кик", "/kick", "кто", "админы", "варны", "/warns", "права", "/rank_perms", "rank_perms"]:
